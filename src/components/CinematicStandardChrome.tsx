  ...
  return (
    <>
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_74%_12%,rgba(232,215,162,0.22),transparent_28%),radial-gradient(circle_at_18%_42%,rgba(232,215,162,0.1),transparent_24%),linear-gradient(115deg,rgba(3,3,3,0.96),rgba(15,12,6,0.78)_48%,rgba(3,3,3,0.96))]" />
        <div className="absolute inset-y-0 right-0 w-[62%] bg-[linear-gradient(90deg,transparent,rgba(232,215,162,0.08)),linear-gradient(rgba(232,215,162,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(232,215,162,0.1)_1px,transparent_1px)] bg-[size:100%_100%,64px_64px,64px_64px] [transform:perspective(760px)_rotateX(58deg)_translateY(9%)] [transform-origin:center]" />
